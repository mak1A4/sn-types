declare class Notify {
   ...
   */
  conferenceCall(sourceRecord?: any): any;
  /**
   ...
   * you want to resume.
   */
  dequeueCall(callRecord: any): any;
  /**
   ...
   */
  forwardCall(call: any, destination: any, dtmf: string): any;
  /**
   ...
   * status.
   */
  getParentCallID(callRecord: any): any;
  /**
   ...
   * phone.
   */
  hasCapability(notifyPhoneNumber: string, capability: string): any;
  /**
   ...
   * methods.
   */
  modifyCall(callRecord: any, notifyAction: any): any;
  /**
