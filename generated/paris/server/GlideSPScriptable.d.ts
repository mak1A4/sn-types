declare class GlideSPScriptable {
   ...
   */
  getField(gr: any, fieldName: string): any;
  /**
   ...
   */
  getFields(gr: any, field_Names: string): any;
  /**
   ...
   * @param field_Names A comma separated list of field names.
   */
  getFieldsObject(gr: any, field_Names: string): any;
  /**
   * Return the form.
   ...
   */
  getRecordVariables(gr: any, includeNilResponses?: boolean): any;
  /**
   ...
   * @param includeNilResponses Optional. If true, the API includes variables with no user-defined value.
   */
  getRecordVariablesArray(gr: any, includeNilResponses?: boolean): any;
  /**
